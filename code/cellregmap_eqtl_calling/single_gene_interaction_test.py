...
# filter to the more interpretable topics--josh did this, but I'll keep all topics.
C = C[['k13','k20','k25']]
...
test_snps = all_tests[all_tests['GENE_HGNC']==g]['VARIANT_ID'].unique()
...
pv = pd.DataFrame({"GENE_HGNC":[g for _ in G_expanded.snp.values],
                  "VARIANT_ID":G_expanded.snp.values,
                  "P_CELLREGMAP":pvals[0]})
#was: "GENE_HGNC":[g for _ in test_snps]
